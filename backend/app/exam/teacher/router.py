...
@router.get("/collections", response_model=BaseReturn[List[JustCollection]])
...
@router.get("/collections/public", response_model=BaseReturn[List[JustCollection]])
...
@router.get("/collections/{collection_id}", response_model=BaseReturn[GetCollection])
...
@router.put("/collections/{collection_id}", response_model=BaseReturn)
...
@router.delete("/collections/{collection_id}", response_model=BaseReturn)
...
@router.put(
    "/collections/{collection_id}/questions/{question_id}", response_model=BaseReturn
)
